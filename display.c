...
* check_eeprom_values: Kollar om det finns några sparade värden i EEPROM.
					   Om det finns läses dessa in och displayerna försätts 
					   i samma tillstånd som innan programmet avslutades. 
					  
					   1. Vi kollar om EEPROM är initierat. Då ligger värdet 0 
					      på EEPROM_INITIALIZED, annars ligger startvärdet 0xFF.
						  
					   2. Om EEPROM är initierat läses värderna in, annars 
					      sätts addresserna i starttillstånd
					   ...
					   4. Läser in uppräkningsriktningen och sparas i variabeln 
